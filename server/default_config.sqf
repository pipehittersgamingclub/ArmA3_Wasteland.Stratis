...
A3W_remoteBombStoreRadius = 10;    // Prevent players from placing remote explosives within this distance from any store (0 = disabled)
...
A3W_atmMaxBalance = 4000000;       // Maximum amount of money that can be stored in a bank account (recommended: 1 million)
